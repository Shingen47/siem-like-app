#!/usr/bin/env python3
"""
CSV Sample Log Generator for SIEM Dashboard Testing
Generates realistic user activity logs in CSV format with honeyfile access and anomalies
"""
...
def save_logs_csv(logs, filename='sample_logs.csv'):
...
if __name__ == '__main__':
    ...
    save_logs_csv(logs, 'sample_logs.csv')
